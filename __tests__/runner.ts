...
store.addQuads([
  ...
  quad(blankNode('6'), namedNode('http://www.w3.org/1999/02/22-rdf-syntax-ns#first'), namedNode('http://example.org/myPath/3-2')),
  quad(blankNode('6'), namedNode('http://www.w3.org/1999/02/22-rdf-syntax-ns#rest'), namedNode('http://www.w3.org/1999/02/22-rdf-syntax-ns#nil')),
]);
